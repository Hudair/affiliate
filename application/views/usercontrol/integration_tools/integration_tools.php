...
<?php if(isset($campaign_count_alert)){ ?>
	<div class="row">
	    ...
	    <div class="alert alert-warning text-center" role="alert">
	        <a href="javascript:void(0)" class="close not-show-alert"><span aria-hidden="true">×</span></a>
	        <p><?= $campaign_count_alert ?></p>
	    </div>
		</div>
	</div>
<?php } ?>
						...
						<table id="myTable" class="table table-striped">
							<thead>
								<tr>
									...
									<th class="text-center"><?= __('user.created_at') ?></th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<div class="step-2" style="display:none;">
      		...
      		<div id="vendor-security-progressbar">
					  <div></div>
					</div>
