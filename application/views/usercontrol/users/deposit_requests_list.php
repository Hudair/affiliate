						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<button type="button" class="btn btn-primary btn-md ml-3 <?= ($vendorDepositStatus['depositstatus']) ? 'btn-deposit-balence' : 'btn-deposit-module-info' ?>"><i class="fa fa-plus"></i> <?= __('admin.deposit_btn_title') ?></button>
								</div>
							</div>
						</div>
					</form>
        ...
        <form id="payment-methods-form" action="<?= base_url('usercontrol/confirm_deposit'); ?>" method="post">
            <div class="form-group payment-amount-box">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control p-4" name="amount" step="0.01" placeholder="<?= __('user.enter_amount') ?>" style="font-size: 24px;">
              </div>
            </div>
