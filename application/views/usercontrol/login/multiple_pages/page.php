            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
						<img src="<?= $logo ?>" class="page-logo <?= ($theme_settings[0]->custom_logo_size) ? 'customLogoClass' : '' ?>" alt="<?= __('front.logo') ?>">
                        <h2><?= (!empty($page_data->page_content_title)) ? $page_data->page_content_title : "What is Lorem Ipsum?" ?></h2>
                        <p><?= (!empty($page_data->top_banner_sub_title)) ? $page_data->top_banner_sub_title : "Lorem Ipsum is simply dummy text of the printing and typesetting industry." ?></p>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
