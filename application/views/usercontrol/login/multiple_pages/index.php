            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="wlc-hero-content">
                        ...
                        <a href="<?= (isset($heroData) && !empty($heroData->link)) ? $heroData->link : base_url('register'); ?>" target="_blank" class="btn-orage"><?= (isset($heroData) && !empty($heroData->button_text)) ? $heroData->button_text : __('front.join_as_affiliate'); ?></a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-6">
                                                <div class="section-title text-center">
                                                    <img src="<?= base_url('assets/login/multiple_pages') ?>/img/icon.png?v=<?= av() ?>" alt="<?= __('front.icon') ?>">
                                                    <?php foreach($theme_settings as $settings) { $membershipTitles = $settings; } ?>
                                                    <h2><?= (isset($membershipTitles) && !empty($membershipTitles->membership_top_title)) ? $membershipTitles->membership_top_title : __('front.best_affiliate_plan'); ?></h2>
                            ...
                            <div class="testimonial-area">
                                <div class="container mb-5">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-6">
                                            <div class="section-title text-center">
                                                <img src="<?= base_url('assets/login/multiple_pages') ?>/img/icon.png?v=<?= av() ?>" alt="<?= __('front.client') ?>">
