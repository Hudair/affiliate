  	...
  	<div class="container">
							...
							<div class="card shadow-sm border-top-card">
								<div class="card-body p-md-5">
									...
									<form id="login-form">
										...
										<div class="form-group">
											<button class="btn btn-primary btn-submit w-100 mt-3"><?= __('store.login') ?></button>
										</div>
									</form>
								</div>
							</div>
								...
								<div class="card-body p-md-5">
									<h5 class="mb-5 display-5"><?= __('store.create_a_new_account') ?></h5>
										<form id="register-form">
											...
											<input type="hidden" name='<?= $name ?>' id="phonenumber-input" value="" class="form-control" placeholder="<?= __('store.phone_number') ?>"  >
											<div class="form-group">
		...
		<?php } ?>
	 	...
	 	<div class="cart-wrapper">
			...
			<div class="checkout-form" <?= (!$is_logged) ? 'style="display:none;"' : ""; ?> >	
