            ...
            <div class="ft-left">
              <div class="logo-ft">
                <a href="<?php echo $home_link ?>">
                    <img alt="<?= __('store.image') ?>" src="<?= $logo ?>" width="110" height="36"/>
                </a>
              </div>
              <div class="ft-social">
...
<div class="modal fade" id="cart-confirm" tabindex="-1" aria-labelledby="cart-confirm" aria-hidden="true">
  ...
  <div class="modal-content">
    ...
    <div class="pop-btn-row">
      ...
      <?php if($product['allow_shipping'] != 0){ ?>
      <a href="javascript:void(0);" type="button" class="btn btn-poup bg-main" data-dismiss="modal"><?= __('store.continue_shopping') ?></a><?php } ?>
