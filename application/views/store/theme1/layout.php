...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/store/theme1/') ?>custom.css">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php } ?>
                    <li class="nav-item active lang-menu header-right-listing">
                    ...
                    <div class="payment-icons">
                        <?php 
                            ...
                            foreach ($payments as $key => $payment) {
                                if($payment['status']){
                                    echo "<img width='50px' src='". base_url($payment['icon']) ."' title='". $payment['title'] ."' >";
                                }
                            }
                        ?>
                    </div>
