	...
	<tr>
		...
		<td>
			<div class="tooltip-copy">
				...
				<div> <small>
					<a target="_blank" href="<?= $productLink.'?preview=1' ?>">Public Page</a>
				</small></div>
			</div>
		</td>
		<td>
		...
		<td class="txt-cntr no-wrap">
			<a class="btn btn-sm btn-primary" onclick="return confirm('<?= __('store.are_you_sure_to_edit') ?>');" href="<?php echo base_url();?>admincontrol/updateproduct/<?php echo $product['product_id'];?>"><i class="fa fa-edit cursors" aria-hidden="true"></i></a>
