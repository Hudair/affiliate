...
<div class="col-md-6">
   ...
   <div class="panel black">
      ...
      <div class="panel-body">
         <pre class="response-view">{ "status": true, "message": "user login successfully", "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.IjIwMjEtMDYtMTEgMTc6MjA6NDRmcmVzaF91c2VyMiI.qWPzdYF2gDDQRoU4x8eR6WrkfQCPw-ONp3mcqsq05lc" }</pre>
      </div>
   </div>
</div>
</div>
