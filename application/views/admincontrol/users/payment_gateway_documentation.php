		...
		<div class="col-sm-12">
		    ...
		    <div class="card">
		    	...
		    	<div class="card-header">
		    		...
		    		<h4 class="card-title pull-left m-0"><?= __('admin.how_to_create_payment_method') ?></h4>

		    		<div class="pull-right">

		    			<a href="<?= base_url('admincontrol/payment_gateway_sample_data_to_pdf') ?>" class="btn btn-primary btn-sm" target="_blank">
		    				<?= __('admin.payment_gateway_doc_sample_data') ?>
		    			</a>

		    			<a href="<?= base_url('admincontrol/payment_gateway_documentation_to_pdf') ?>" class="btn btn-primary btn-sm" target="_blank">
		    	...
		    	<div class="card-body payment-doc">
		    		...
		    		<div id="wpg-doc">
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0">#1 <?= __('admin.payment_gateway_doc_controller_folder') ?></h2>
		    				</div>
	    					<div class="card-body">
	    						<p>
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0">#2 <?= __('admin.payment_gateway_doc_setting_folder') ?></h2>
		    				</div>
	    					<div class="card-body">
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0">#3 <?= __('admin.payment_gateway_doc_view_folder') ?></h2>
		    				</div>
	    					<div class="card-body">
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0">#4 <?= __('admin.payment_gateway_doc_library_folder') ?></h2>
		    				</div>
	    					<div class="card-body">
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0">#5 <?= __('admin.payment_gateway_doc_logo_folder') ?></h2>
		    				</div>
	    					<div class="card-body">
	    						<?= __('admin.payment_gateway_doc_logo_info') ?>
	    						<ul>
	    							<li><strong>custom/logo/custom.png</strong></li>
	    						</ul>
	    					</div>
		    			</div>
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0"><?= __('admin.payment_gateway_doc_payment_confirmation') ?></h2>
		    				</div>
	    					<div class="card-body">
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0"><?= __('admin.payment_gateway_doc_status_id_and_title') ?></h2>
		    				</div>
		    			...
		    			<div class="card">
		    				<div class="card-header">
		    					<h2 class="mb-0"><?= __('admin.payment_gateway_doc_zip_file') ?></h2>
		    				</div>
	    					<div class="card-body">
