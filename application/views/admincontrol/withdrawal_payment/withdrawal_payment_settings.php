<div class="card">
	<div class="card-header">
		<h6 class="card-title pull-left m-0"><?= __('admin.settings') ?> <small><?= $details['title'] ?></small></h6>
		<div class="card-options pull-right">
			<button class="btn btn-primary btn-sm btn-submit"><?= __('admin.save_settings') ?></button>
		</div>
	</div>
	<div class="card-body">
		<form method="post" action="" id='form-setting'>
			...
			<?php
				...
				{
					?>
						<div id="custom-field-section" class="row">
						<?php
					...
					<div class="col-md-12">
						...
						<button id="add-more-field-btn" type="button" class="btn btn-default btn-md"><i class="fa fa-plus"></i> <?= __('admin.add_more_fields') ?></button>
