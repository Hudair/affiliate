				...
				<form id="admin-form">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input placeholder="<?= __('admin.description') ?>" name="description" class="form-control" value="<?php echo $slider->description; ?>" type="text">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="control-label"><?= __('admin.link') ?></label>
								<input placeholder="<?= __('admin.link') ?>" name="link" id="link" class="form-control" value="<?php echo $slider->link; ?>" type="text">
					...
					<div class="form-group">
						...
						<div class="fileUpload btn btn-sm btn-primary">
							...
							<input id="uploadBtn" name="avatar" class="upload" type="file" onchange="loadFile(event)" accept="image/*">
						</div>
						
						<?php $avatar = $slider->image != '' ? $slider->image : 'no-image-available.gif' ; ?>
					
						<img id="output"  src="<?php echo base_url().'assets/images/'.$avatar;?>" class="thumbnail" border="0" width="220px" />
