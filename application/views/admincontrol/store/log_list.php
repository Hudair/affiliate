...
<?php foreach($clicks as $index => $order){ ?>
	...
	<tr class="detail-tr">
		<td colspan="100%">
            <div>
                <ul>
					<li><b><?= __('admin.product_id') ?> : </b> <span><?= $order['product_id'] ?></span></li>
                </ul>
           	</div>
      	</td>
	</tr>
			...
			<td colspan="100%">
	            <div>
	                <ul>
						...
						<li><b><?= __('user.browser') ?> : </b> <span><?= $order['browserName'] ?> - <small><?= $order['browserVersion'] ?></small></span></li>
						<li><b><?= __('user.os_platform') ?> : </b> <span><?= $order['osPlatform'] ?> -  <small> <?= __('user.version') ?> : <?= $order['osVersion'] ?></small></span></li>
