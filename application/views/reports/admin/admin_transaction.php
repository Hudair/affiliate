<div class="card">
	<div class="card-header">
		<h4 class="card-title"><?= __('admin.menu_report_all_transactions') ?></h4>
	</div>
	<div class="card-body">	
				...
				<tr>
					...
					<td><?php echo $value['username'] ?></td>			
						...
						<td><?= (!empty($value['payment_method'])) ? __('admin.'.strtolower(str_replace(' ','_',$value['payment_method']))) : '<small class="text-muted">'.__('admin.not_available').'</small>' ?></td>
						<td>
							<?php
